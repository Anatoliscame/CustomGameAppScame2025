...
{
    public class OnUpdateProductDetailsCheckColumns : IPlugin
    {
        public void Execute(IServiceProvider serviceProvider)
        {
            try
            {
                ...
                OnUpdateProductDetailsCheckColumnsLogic bl = new OnUpdateProductDetailsCheckColumnsLogic();

                trace.Trace("Start Plugin OnUpdateProductDetailsCheckColumns");
                ...
                trace?.Trace("End Plugin OnUpdateProductDetailsCheckColumns");
