...
{
    public class OnCreateUpdateProdottoDigitaleCheckLogic
    {
        ...
        public void ExecuteProdottoDigitale(IOrganizationService service, Entity prodottoDigitale, string messageName, ITracingService trace)
        {
            ...
            if (messageName.ToLower() == "create")
            {
                ...
                var codiceTo = prodottoDigitale.GetAttributeValue<string>(ProdottoDigitale.Codice);

                if (!prodottoDigitale.TryGetAttributeValue(ProdottoDigitale.Name, out string nameTo))
                {
                ...
                int? typePD = prodottoDigitale.Contains(ProdottoDigitale.TypeProdottoDigitale)
                     ? prodottoDigitale.GetAttributeValue<OptionSetValue>(ProdottoDigitale.TypeProdottoDigitale)?.Value
                     : null;
                int? typePiattaformaPD = prodottoDigitale.Contains(ProdottoDigitale.TypePiattaforma)
                    ? prodottoDigitale.GetAttributeValue<OptionSetValue>(ProdottoDigitale.TypePiattaforma)?.Value
                     : null;
                int? statoePD = prodottoDigitale.Contains(ProdottoDigitale.StatoProdottoDigitale)
                     ? prodottoDigitale.GetAttributeValue<OptionSetValue>(ProdottoDigitale.StatoProdottoDigitale)?.Value
                     : null;
