...
CustomApp.mainKeyProduct = new function () {
    var _self = this;

    _self.onload = function (executionContext) {
        var formContext = executionContext.getFormContext();

        var keydigitaleValue = formContext.getAttribute("sc_keydigitale") != null
            ? formContext.getAttribute("sc_keydigitale").getValue()
            : null;
    ...
    _self.HideTypePiattaforma = function (executionContext) {
        ...
        var prodottoDigitaleValue = formContext.getAttribute("sc_prodottodigitaleid").getValue();
        ...
        Xrm.WebApi.retrieveRecord("sc_prodottodigitale", prodottoDigitaleId, "?$select=sc_prodottodigitaleid,sc_tipoprodottodigitale").then(
            function (prodottoDigitale) {

                var prodottodigitaleid = prodottoDigitale["sc_prodottodigitaleid"]; // Guid
                var tipoprodottodigitale = prodottoDigitale["sc_tipoprodottodigitale"]; // Choice

                var piattaformaControl = formContext.getControl("sc_typepiattaforma");
