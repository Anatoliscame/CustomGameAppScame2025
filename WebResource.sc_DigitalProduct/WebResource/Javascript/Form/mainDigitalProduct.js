...
CustomApp.mainDigitalProduct = new function () {
    ...
    _self.OpenSpecificEntityAfterCreate = function (executionContext) {
        ...
        data["sc_name"] = formContext.getAttribute("sc_name").getValue();
        data["sc_typedigitalproduct"] = tipoProduct;
        ...
        Xrm.WebApi.createRecord(entityName, data).then(
            function success(result) {
                ...
                updateProdottoDigitale["sc_productdetailsid@odata.bind"] = "/sc_productdetailses(" + productDetailsId + ")";

                Xrm.WebApi.updateRecord("sc_digitalproduct", prodottoDigitaleId, updateProdottoDigitale).then(
                    function successUpdate() {

                        Xrm.Utility.closeProgressIndicator();

                        Xrm.Navigation.openForm({
                            entityName: "sc_digitalproduct",
